...
namespace cashfree_payout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateBatchTransferResponse")]
    public class CreateBatchTransferResponse : IEquatable<CreateBatchTransferResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBatchTransferResponse" /> class.
        /// </summary>
        /// <param name="batchTransferId">It displays the unique ID you created to identify the batch transfer request..</param>
        ...
        /// <param name="status">It displays the status of the API request..</param>
        public CreateBatchTransferResponse(string batchTransferId = default(string), string cfBatchTransferId = default(string), string status = default(string))
        {
        ...
        /// </summary>
        /// <value>It displays the unique ID you created to identify the batch transfer request.</value>
        ...
        /// </summary>
        /// <value>It displays the status of the API request.</value>
        ...
        {
            return this.Equals(input as CreateBatchTransferResponse);
        }

        /// <summary>
        /// Returns true if CreateBatchTransferResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateBatchTransferResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateBatchTransferResponse input)
        {
            if (input == null)
            {
                return false;
