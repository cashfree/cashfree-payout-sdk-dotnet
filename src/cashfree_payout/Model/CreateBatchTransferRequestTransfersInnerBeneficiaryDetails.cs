...
namespace cashfree_payout.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateBatchTransferRequest_transfers_inner_beneficiary_details")]
    public class CreateBatchTransferRequestTransfersInnerBeneficiaryDetails : IEquatable<CreateBatchTransferRequestTransfersInnerBeneficiaryDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBatchTransferRequestTransfersInnerBeneficiaryDetails" /> class.
        /// </summary>
        ...
        /// <param name="beneficiaryName">It is the name of the beneficiary. The maximum character limit is 100..</param>
        ...
        public CreateBatchTransferRequestTransfersInnerBeneficiaryDetails(string beneficiaryId = default(string), string beneficiaryName = default(string), CreateBatchTransferRequestTransfersInnerBeneficiaryDetailsBeneficiaryInstrumentDetails beneficiaryInstrumentDetails = default(CreateBatchTransferRequestTransfersInnerBeneficiaryDetailsBeneficiaryInstrumentDetails), CreateTransferRequestBeneficiaryDetailsBeneficiaryContactDetails beneficiaryContactDetails = default(CreateTransferRequestBeneficiaryDetailsBeneficiaryContactDetails))
        {
        ...
        /// </summary>
        /// <value>It is the name of the beneficiary. The maximum character limit is 100.</value>
        ...
        public CreateBatchTransferRequestTransfersInnerBeneficiaryDetailsBeneficiaryInstrumentDetails beneficiary_instrument_details { get; set; }
        ...
        {
            return this.Equals(input as CreateBatchTransferRequestTransfersInnerBeneficiaryDetails);
        }

        /// <summary>
        /// Returns true if CreateBatchTransferRequestTransfersInnerBeneficiaryDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateBatchTransferRequestTransfersInnerBeneficiaryDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateBatchTransferRequestTransfersInnerBeneficiaryDetails input)
        {
            if (input == null)
            {
                return false;
