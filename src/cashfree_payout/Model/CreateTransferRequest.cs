...
namespace cashfree_payout.Model
{
    ...
    public class CreateTransferRequest : IEquatable<CreateTransferRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="fundsourceId">It is the ID of the fund source from which the transfer amount will be debited..</param>
        public CreateTransferRequest(string transferId = default(string), double transferAmount = default(double), string transferCurrency = default(string), TransferModeEnum? transferMode = default(TransferModeEnum?), CreateTransferRequestBeneficiaryDetails beneficiaryDetails = default(CreateTransferRequestBeneficiaryDetails), string transferRemarks = default(string), string fundsourceId = default(string))
        {
        ...
        public CreateTransferRequestBeneficiaryDetails beneficiary_details { get; set; }
        ...
        /// </summary>
        /// <value>It is the ID of the fund source from which the transfer amount will be debited.</value>
